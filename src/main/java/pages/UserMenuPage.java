...
/**
 * This page contains all the required page objects elements and methods of usermenu page
 * @author chimela
 * @version v1.0
 */
public class UserMenuPage extends BasePage {
	...
	public WebElement photoSpinnerIcon;
	 ...
	 * @return true if given option is selected else false
	 */
	...
	public boolean selectDeveloperConsole() {
		boolean isSelected = false;
...
//	public void switchToDeveloperConsole(WebDriver driver) {
...
//				Thread.sleep(WaitConstants.WAIT_FOR_UPLOAD_TO_FINISH);
	...
	public boolean verifyPhotoUpload(WebDriver driver, String sPhotoPath) throws InterruptedException {
		...
		if(CommonUtils.waitForElementToDisappear(driver, photoSpinnerIcon)
